...
function hm_theme_js() {
    ...
    wp_register_script( 'hm_dependencies', get_template_directory_uri() . '/js/dependencies.min.js', 0, false );
    wp_register_script( 'hm_theme', get_template_directory_uri() . '/js/site.js', array( 'jquery','hm_dependencies' ), 0, false );
